...
```html
<template>
  <d-button :plain="true" @click="open">Afficher le message</d-button>
  <d-button :plain="true" @click="openVn">VNode</d-button>
</template>
...
```html
<template>
  <d-button :plain="true" @click="open2">success</d-button>
  <d-button :plain="true" @click="open3">warning</d-button>
  <d-button :plain="true" @click="open1">message</d-button>
  <d-button :plain="true" @click="open4">error</d-button>
</template>
...
```html
<template>
  <d-button :plain="true" @click="openCenter">Texte centré</d-button>
</template>
...
```html
<template>
  <d-button :plain="true" @click="openHTML">Utiliser du HTML</d-button>
</template>
