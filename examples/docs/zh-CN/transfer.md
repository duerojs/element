...
```html
<template>
  <d-transfer v-model="value" :data="data"></d-transfer>
</template>
...
<template>
  ...
  <div style="text-align: center">
    <d-transfer
      ...
      @change="handleChange"
      :data="data">
      <d-button class="transfer-footer" slot="left-footer" size="small">操作</d-button>
      <d-button class="transfer-footer" slot="right-footer" size="small">操作</d-button>
    </d-transfer>
  </div>
