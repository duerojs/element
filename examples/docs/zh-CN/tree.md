...
<div class="buttons">
  <d-button @click="getCheckedNodes">通过 node 获取</d-button>
  <d-button @click="getCheckedKeys">通过 key 获取</d-button>
  <d-button @click="setCheckedNodes">通过 node 设置</d-button>
  <d-button @click="setCheckedKeys">通过 key 设置</d-button>
  <d-button @click="resetChecked">清空</d-button>
</div>
