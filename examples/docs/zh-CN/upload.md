...
<d-upload
  ...
  <div slot="tip" class="d-upload__tip">只能上传jpg/png文件，且不超过500kb</div>
</d-upload>
<script>
  export default {
    data() {
...
<d-upload
  ...
  <div class="d-upload__text">将文件拖到此处，或<em>点击上传</em></div>
  <div class="d-upload__tip" slot="tip">只能上传jpg/png文件，且不超过500kb</div>
</d-upload>
```
:::
