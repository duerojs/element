    ...
    <span
      ...
      <i
        ...
        <i
          ...
          :style="decimalStyle"
          class="d-rate__decimal">
        </i>
      </i>
    </span>
    <span v-if="showText || showScore" class="d-rate__text" :style="{ color: textColor }">{{ text }}</span>
  </div>
</template>
  ...
  export default {
    ...
    props: {
      ...
      iconClasses: {
        type: [Array, Object],
        default() {
          return ['d-icon-star-on', 'd-icon-star-on', 'd-icon-star-on'];
        }
      },
      voidIconClass: {
        type: String,
        default: 'd-icon-star-off'
      },
      disabledVoidIconClass: {
        type: String,
        default: 'd-icon-star-on'
      },
      disabled: {
        type: Boolean,
        default: false
    ...
    methods: {
      ...
      setCurrentValue(value, event) {
        ...
        if (this.allowHalf) {
          ...
          if (hasClass(target, 'd-rate__item')) {
            target = target.querySelector('.d-rate__icon');
          }
          if (hasClass(target, 'd-rate__decimal')) {
