...
describe('Card', () => {
  ...
  it('slot:header', () => {
    ...
    expect(vm.$el.querySelector('.d-card__header')).to.property('textContent').to.include('二师兄叫我埋梗 啦啦啦');
  });
  ...
  it('header', () => {
    ...
    expect(vm.$el.querySelector('.d-card__header')).to.property('textContent').to.include('好烦');
  });
  ...
  it('bodyStyle', () => {
    ...
    expect(vm.$el.querySelector('.d-card__body').style.padding).to.equal('10px');
  });
