...
describe('MessageBox', () => {
  ...
  afterEach(() => {
    const el = document.querySelector('.d-message-box__wrapper');
    if (!el) return;
    if (el.parentNode) {
  ...
  it('create and close', done => {
    ...
    setTimeout(() => {
      const msgbox = document.querySelector('.d-message-box__wrapper');
      expect(msgbox.__vue__.$parent.visible).to.true;
      expect(msgbox.querySelector('.d-message-box__title span').textContent).to.equal('消息');
      expect(msgbox.querySelector('.d-message-box__message')
  ...
  it('invoke with strings', done => {
    ...
    setTimeout(() => {
      expect(document.querySelector('.d-message-box__wrapper')).to.exist;
      done();
    }, 300);
  });
  ...
  it('custom icon', done => {
    MessageBox({
      type: 'warning',
      iconClass: 'd-icon-question',
      message: '这是一段内容'
    });
    setTimeout(() => {
      const icon = document.querySelector('.d-message-box__status');
      expect(icon.classList.contains('d-icon-question')).to.true;
      done();
    }, 300);
  });
  ...
  it('html string', done => {
    ...
    setTimeout(() => {
      const message = document.querySelector('.d-message-box__message strong');
  ...
  it('distinguish cancel and close', done => {
    ...
    setTimeout(() => {
      document.querySelector('.d-message-box__close').click();
      setTimeout(() => {
  ...
  it('alert', done => {
    ...
    setTimeout(() => {
      ...
      expect(document.querySelector('.d-message-box__wrapper')
  ...
  it('confirm', done => {
    ...
    setTimeout(() => {
      document.querySelector('.d-message-box__wrapper')
        .querySelector('.d-button--primary').click();
      expect(document.querySelector('.d-message-box__wrapper')
  ...
  it('prompt', done => {
    ...
    setTimeout(() => {
      const messageBox = document.querySelector('.d-message-box__wrapper').__vue__.$parent;
      expect(messageBox.$el.querySelector('.d-message-box__input')).to.exist;
      ...
      setTimeout(() => {
        expect(messageBox.$el.querySelector('.d-message-box__errormsg')
  ...
  describe('custom validator', () => {
    it('returns a string', done => {
      ...
      setTimeout(() => {
        ...
        messageBox.inputValue = 'no';
        setTimeout(() => {
          expect(document.querySelector('.d-message-box__errormsg')
  ...
  it('beforeClose', done => {
    ...
    setTimeout(() => {
      document.querySelector('.d-message-box__wrapper .d-button--primary').click();
      setTimeout(() => {
  ...
  describe('promise', () => {
    ...
    it('reject', done => {
      ...
      setTimeout(() => {
        document.querySelector('.d-message-box__wrapper .d-button').click();
      }, 50);
    });
  });
});
