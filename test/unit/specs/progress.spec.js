...
describe('Progress', () => {
  ...
  it('status', () => {
    ...
    expect(vm.$refs.lineSuccess.$el.querySelector('.el-progress__text .d-icon-circle-check')).to.be.exist;
    expect(vm.$refs.lineException.$el.classList.contains('is-exception')).to.be.true;
    expect(vm.$refs.lineException.$el.querySelector('.el-progress__text .d-icon-circle-close')).to.be.exist;

    expect(vm.$refs.circleSuccess.$el.classList.contains('is-success')).to.be.true;
    expect(vm.$refs.circleSuccess.$el.querySelector('.el-progress__text .d-icon-check')).to.be.exist;
    expect(vm.$refs.circleException.$el.classList.contains('is-exception')).to.be.true;
    expect(vm.$refs.circleException.$el.querySelector('.el-progress__text .d-icon-close')).to.be.exist;
  });
  it('text inside', () => {
    vm = createVue({
      template: `
