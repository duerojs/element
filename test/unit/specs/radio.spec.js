...
describe('Radio', () => {
  ...
  it('create', done => {
    ...
    let radioElm = vm.$el;
    expect(radioElm.classList.contains('d-radio')).to.be.true;
    radioElm.click();
    setTimeout(_ => {
  ...
  describe('Radio group', () => {
      ...
      vm = createVue({
        template: `
          <d-radio-group v-model="radio">
            <d-radio :label="3" ref="radio1">备选项</d-radio>
            <d-radio :label="6" ref="radio2">备选项</d-radio>
    ...
    it('disabled', done => {
      vm = createVue({
        template: `
          <d-radio-group v-model="radio" disabled>
            <d-radio :label="3" ref="radio1">备选项</d-radio>
            <d-radio :label="6" ref="radio2">备选项</d-radio>
            <d-radio :label="9">备选项</d-radio>
          </d-radio-group>
    ...
    it('change event', done => {
      vm = createVue({
        template: `
          <d-radio-group v-model="radio" @change="onChange">
    ...
    it('disabled when children is radio button', done => {
      vm = createVue({
        template: `
          <d-radio-group v-model="radio" disabled>
            <d-radio-button :label="3" ref="radio1">备选项</d-radio-button>
            <d-radio-button :label="6" ref="radio2">备选项</d-radio-button>
            <d-radio-button :label="9">备选项</d-radio-button>
          </d-radio-group>
        `,
        data() {
          return {
    ...
    it('keyboard event', done => {
      vm = createVue({
        template: `
          <d-radio-group v-model="radio">
            <d-radio-button ref="radio1" :label="3">备选项</d-radio-button>
            <d-radio-button ref="radio2" :label="6">备选项</d-radio-button>
            <d-radio-button ref="radio3" :label="9">备选项</d-radio-button>
          </d-radio-group>
        `,
        data() {
          return {
    ...
    describe('Radio Button', () => {
      ...
      it('custom color', done => {
        vm = createVue({
          template: `
            <d-radio-group v-model="radio" fill="#000" text-color="#ff0">
              <d-radio-button :label="3" ref="radio1">备选项</d-radio-button>
              <d-radio-button :label="6" ref="radio2">备选项</d-radio-button>
              <d-radio-button :label="9">备选项</d-radio-button>
            </d-radio-group>
      ...
      it('change event', done => {
        vm = createVue({
          template: `
            <d-radio-group v-model="radio" @change="onChange">
              <d-radio-button :label="3">备选项</d-radio-button>
              <d-radio-button :label="6" ref="radio2">备选项</d-radio-button>
              <d-radio-button :label="9">备选项</d-radio-button>
            </d-radio-group>
          `,
      ...
      it('size', done => {
        vm = createVue({
          template: `
            <d-radio-group v-model="radio" size="large">
              <d-radio-button :label="3" ref="radio1">备选项</d-radio-button>
              <d-radio-button :label="6" ref="radio2">备选项</d-radio-button>
              <d-radio-button :label="9">备选项</d-radio-button>
            </d-radio-group>
        ...
        setTimeout(_ => {
          expect(vm.$el.querySelectorAll('.d-radio-button--large').length).to.be.equal(3);
          done();
        }, 10);
      });
    });
